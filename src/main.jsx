...
if (matchResult.matches) {
  const images = [
    // Front
    { position: [0, 1.2, -4], rotation: [0, 0, 0], url: pexel(0) },
    // Back
    { position: [-1.25, 1.2, -4], rotation: [0, 0, 0], url: pexel(7) },
    { position: [1.25, 1.2, -4], rotation: [0, 0, 0], url: pexel(5) },
    // Left
    { position: [-1.25, 2.4, -4], rotation: [0, 0, 0], url: pexel(3) },
    { position: [0, 2.4, -4], rotation: [0, 0, 0], url: pexel(4) },
    { position: [1.25, 2.4, -4], rotation: [0, 0, 0], url: pexel(1) },
    // Right
    { position: [-1.25, 0, -4], rotation: [0, 0, 0], url: pexel(6) },
    { position: [0, 0, -4], rotation: [0, 0, 0], url: pexel(2) },
    { position: [1.25, 0, -4], rotation: [0, 0, 0], url: pexel(9) }
  ]
